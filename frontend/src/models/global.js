import {queryClassTop, queryLogData, queryPlayer, queryRankList, queryTimeline} from "@/services/api";
...
const GlobalModel = {
  ...
  effects: {
    * fetchLogData({payload}, {call, put, select}) {
      const result = yield call(queryLogData, payload);
      if (result.code !== 200) {
